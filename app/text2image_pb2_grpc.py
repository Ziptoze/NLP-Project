...
class Text2ImageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateImageFromImage = channel.unary_unary(
                '/text2image.Text2ImageService/GenerateImageFromImage',
                request_serializer=text2image__pb2.ImageToImagePrompt.SerializeToString,
                response_deserializer=text2image__pb2.ImageResponse.FromString,
                _registered_method=True)
...
def add_Text2ImageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateImageFromImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=text2image__pb2.ImageToImagePrompt.FromString,
                    response_serializer=text2image__pb2.ImageResponse.SerializeToString,
            ),
    }
...
class Text2ImageService(object):
    ...
    def GenerateImageFromImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/text2image.Text2ImageService/GenerateImageFromImage',
            text2image__pb2.ImageToImagePrompt.SerializeToString,
            text2image__pb2.ImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
